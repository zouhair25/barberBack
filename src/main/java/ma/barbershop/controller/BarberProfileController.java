...
public class BarberProfileController {
    ...
    @GetMapping
    public ResponseEntity<BarberProfile> getProfile(@AuthenticationPrincipal UserPrincipal principal) {
        BarberProfile profile = barberProfileRepository.findByUserId(principal.getId())
    ...
    @PutMapping
    @Transactional
    public ResponseEntity<BarberProfile> updateProfile(
        ...
        return ResponseEntity.ok(barberProfileRepository.save(profile));
    }
    ...
    public ResponseEntity<List<OpeningHours>> updateHours(
        ...
        BarberProfile barber = barberProfileRepository.findById(barberId).orElseThrow();
    ...
    public ResponseEntity<Void> removeClosingDay(
        ...
        if (!cd.getBarber().getId().equals(principal.getBarberId())) {
